...
class PropertyAvailabilityRepositoryImpl(
    ...
    override fun findById(id: Long): PropertyAvailability? = this.jpaPropertyAvailabilityRepository.findByIdOrNull(id)
    ...
    override fun deleteById(id: Long) = this.jpaPropertyAvailabilityRepository.deleteById(id)
