...
class ComponentRatingRepositoryImpl(
    ...
    override fun findAll(): List<ComponentRating> = this.jpaComponentRatingRepository.findAll()

    override fun findById(id: Long): ComponentRating? = this.jpaComponentRatingRepository.findByIdOrNull(id)

    override fun save(componentRating: ComponentRating): ComponentRating = this.jpaComponentRatingRepository.save(componentRating)
    ...
    override fun averageRatingByPropertyAndComponentRating(
        propertyId: Long,
        componentRating: Long,
    ): AverageComponentRatingDTO? = this.jpaComponentRatingRepository.averageRatingByPropertyAndComponentRating(propertyId, componentRating)
}
