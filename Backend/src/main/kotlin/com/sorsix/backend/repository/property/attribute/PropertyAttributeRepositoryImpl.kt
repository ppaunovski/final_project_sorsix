...
class PropertyAttributeRepositoryImpl(
    ...
    override fun findAll(): List<PropertyAttribute> = this.jpaPropertyAttributeRepository.findAll()

    override fun findById(id: Long): PropertyAttribute? = this.jpaPropertyAttributeRepository.findByIdOrNull(id)

    override fun save(propertyAttribute: PropertyAttribute): PropertyAttribute = this.jpaPropertyAttributeRepository.save(propertyAttribute)
