...
VALUES ('Wi-Fi', 'Connection to internet in the property.', 'wifi'),
       ...
       ('Washer', 'Connection to internet in the property.', 'local_laundry_service'),
       ('Garden', 'Connection to internet in the property.', 'yard'),
       ('Smoke alarm', 'Connection to internet in the property.', 'vape_free'),
